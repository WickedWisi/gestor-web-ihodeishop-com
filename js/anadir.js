document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Cargar categorías
  try {
    const res = await fetch("https://ihodeishop.com/php/obtenerCategorias.php");
  ...
  document.getElementById("guardar").addEventListener("click", async () => {
    ...
    try {
      ...
      const uploadRes = await fetch(
        "https://ihodeishop.com/php/subirImagen.php",
      ...
      const linkRes = await fetch(
        "https://ihodeishop.com/php/generarEnlaceStripe.php",
        {
          method: "POST",
      ...
      const guardarRes = await fetch(
        "https://ihodeishop.com/php/guardarProd.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
