document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    const resActivos = await fetch("https://iHodeiShop.com/php/getHoras.php");
    ...
    const resDesactivados = await fetch(
      "https://iHodeiShop.com/php/obtenerPaquetesDesactivados.php"
    );
  ...
  guardarBtn.addEventListener("click", async () => {
    ...
    try {
      const res = await fetch(
        "https://ihodeishop.com/php/actualizarEstadoPaquetes.php",
        {
          method: "POST",
