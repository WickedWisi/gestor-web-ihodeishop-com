document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const catRes = await fetch(
      "https://ihodeishop.com/php/obtenerCategorias.php"
    );
  ...
  // Cargar producto
  try {
    const res = await fetch("https://ihodeishop.com/php/obtenerBonos.php");
  ...
  document.getElementById("guardar").addEventListener("click", async () => {
    ...
    try {
      const res = await fetch(
        "https://iHodeiShop.com/php/actualizarProducto.php",
        {
          method: "POST",
